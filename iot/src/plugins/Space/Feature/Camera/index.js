...
export class Camera {
	...
	init() {
		...
		this.qspace.panoramaCamera.addEventListener(SDK_EVENT_NAME_ENUM.PANORAMA_CAMERA_ROTATION, () => {
			this.space.feature.tag.computeTagVisible([TAG_VISIBLE_COMPUTE_RULE_ENUM.OUT_CAMERA])
		})
	}
